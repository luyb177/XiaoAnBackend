			...
			[]rest.Route{
				{
					...
					Method:  http.MethodPost,
					Path:    "/ask",
					Handler: qa.AskHandler(serverCtx),
				},
			}...,
		),
		rest.WithPrefix("/api/qa/sse"),
			...
			[]rest.Route{
				{
					...
					Method:  http.MethodGet,
					Path:    "/get-messages",
					Handler: qa.GetMessagesHandler(serverCtx),
				},
				{
					// 获取或创建问答会话
					Method:  http.MethodGet,
					Path:    "/get-or-create-session",
					Handler: qa.GetOrCreateSessionHandler(serverCtx),
				},
				{
					// 获取问答会话列表
					Method:  http.MethodGet,
					Path:    "/get-sessions",
					Handler: qa.GetSessionsHandler(serverCtx),
				},
			}...,
		),
