...
type (
	...
	CommentModel interface {
		...
		SoftDeleteByTypeAndTargetId(ctx context.Context, tp string, targetId uint64, deletedAt uint64) (sql.Result, error)
		SoftDeleteByTypeAndTargetIdWithSession(ctx context.Context, session sqlx.Session, tp string, targetId uint64, deletedAt uint64) (sql.Result, error)
	}
...
func (m *customCommentModel) SoftDeleteByTypeAndTargetId(ctx context.Context, tp string, targetId uint64, deletedAt uint64) (sql.Result, error) {
	query := fmt.Sprintf(`
	update %s
	set deleted_at = ?
...
func (m *customCommentModel) SoftDeleteByTypeAndTargetIdWithSession(ctx context.Context, session sqlx.Session, tp string, targetId uint64, deletedAt uint64) (sql.Result, error) {
